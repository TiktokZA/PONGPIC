...
<body class="host_version" bgcolor="#fb743e">
    ...
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
            ...
            <div class="carousel-inner" role="listbox">s
                ...
                <div class="carousel-item" style="background-image:url('images/img03.png');">
                </div>
                <!-- Slide Three - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image:url('images/img02.png');">
                </div>

                <div class="carousel-item " style="background-image:url('images/img04.png');">
                </div>

                <div class="carousel-item " style="background-image:url('images/img05.jpg');">
                </div>
            </div>
