...
<body class="host_version">
    ...
    <header>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image:url('Aboutus/SJ.png');">
                </div>
                <!-- Slide Two - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image:url('Aboutus/memee.png');">
                </div>
                <!-- Slide Three - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image:url('Aboutus/brook.png');">
                </div>
        
                <div class="carousel-item " style="background-image:url('Aboutus/pew.png');">
                </div>
        
                <div class="carousel-item " style="background-image:url('Aboutus/por.png');">
                </div>
            </div>
    ...
    <footer class="py-4 bg-dark height-10">
        <div class="container font1 ">
            ...
            <p class="m-1 text-center text-white">E-mail: sjpongswork101@gmail.com</p>
            <p class="m-0 text-center text-white">Copyright &copy; 2021 PongsPic Production, System analysis and design Department of Computer and Information Science KMUTNB. All rights reserved.</p>
        </div>
    </footer>
