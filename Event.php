...
<body class="host_version" bgcolor="#f3dbb7">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(isset($_SESSION['username'])) { ?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdown-a">
                                    <a class="dropdown-item" href="indexx.php?logout='1'">Logout </a>
    ...
    <!-- End header -->
    <!----------------------------------ส่วนตรงกลางงงงง------------------------------------>
    <p class="m-1 text-center text-black font3">EVENT</p>
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e1.jpg"><img src="images/e1.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e2.jpg"><img src="images/e2.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e3.jpg"><img src="images/e3.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e4.jpg"><img src="images/e4.jpg" width="350" height="250" alt=""></a></button>
    </button>
    <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e5.jpg"><img src="images/e5.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e6.jpg"><img src="images/e6.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e7.jpg"><img src="images/e7.jpg" width="350" height="250" alt=""></a></button>
    </button>
    &nbsp;&nbsp;
    <button>
        <a href="file:///D:/sa/photo/images/e8.jpg"><img src="images/e8.jpg" width="350" height="250" alt=""></a></button>
    </button>
    <br><br>
    <!--------------------------------จบส่วนกลาง------------------------------  -->
